      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
        ...
        <div className="mb-16 lg:mb-20">
          ...
          <motion.h1
            ...
            className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl leading-[0.95] tracking-tight text-navy max-w-6xl"
          >
            {t('hero.tagline')}{' '}
